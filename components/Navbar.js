  ...
  return (
    <>
      <nav className="fixed top-0 w-full shadow-md z-50">
        ...
        {isMenuOpen && (
          <ul className="flex flex-col w-[70%] h-[90vh] absolute right-0 items-start bg-[#a9d3f0] text-[#0680d0] text-base px-6 py-9 md:hidden gap-4 shadow-md">
            <li>
      ...
      <div className="fixed bottom-0 left-0 w-full bg-white shadow-md z-50 block md:hidden">
        <div className="flex justify-around py-3 text-[#0680d0] text-sm font-medium">
          <Link href="/Cart" target="_blank">
                Cart
          </Link>
          <div
            ...
            >
              <span className="cursor-pointer">Profile</span>
              {isProfileVisible && (
                <div className="absolute bottom-8 transform -translate-x-1/2 bg-[#71c1f6cf] text-black p-4 w-72 rounded shadow-md z-10">
                  <h3 className="font-bold text-lg mb-1">
                    Welcome, {session ? session.user.name : "Guest"}!
                  </h3>
                  <p className="text-sm mb-3">To access your account</p>
