      ...
      <div className="flex justify-center items-center social-login-btn">
        <div className="flex flex-col gap-8 min-h-screen">
          ...
          onClick={() => {
             ...
             className="flex items-center bg-[#44b1f9] border border-[#54b7fa] rounded-lg shadow-md max-w-sm px-14 py-4 text-sm font-medium hover:bg-[#6dc0f7] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0680d0]">
            <svg
          ...
          {emailSent ? (
            <p className="text-[#0680d0] text-center">
            ...
            <div className="flex flex-col gap-3">
              <input
                ...
                className="bg-[#44b1f9] border border-[#54b7fa] rounded-lg shadow-md max-w-sm px-6 py-4 text-sm font-medium hover:bg-[#6dc0f7] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0680d0] placeholder:text-[#3d82b0] placeholder:text-center"
                value={email}
              ...
              <button
                ...
                disabled={loading}
                className="w-full border bg-[#0680d0] text-black font-semibold shadow-md mt-4 py-4 px-4 rounded-lg hover:bg-[#44b1f9] disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0680d0]"
              >
