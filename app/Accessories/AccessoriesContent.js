...
const AccessoriesContent = () => {
  ...
  const section4 = getSectionData(9); // optional if enough items
  ...
  return (
    <div className="py-20 px-16">
      ...
      {/* {section5.items.length === 3 && (
        <section className="section4 flex flex-row mt-24">
          <div className="mt-16 w-[32%] mx-44">
            <AccessoriesHeadings title={section5.title} desc={section5.desc} />
          </div>
          <AccessoriesGrid images={section5.items} />
        </section>
      )} */}
    </div>
  );
